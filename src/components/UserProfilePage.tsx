        ...
        return (
            <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black p-8">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-gray-400 mt-2">This profile doesn't exist or you don't have access to view it.</p>
                </div>
            </div>
        );
    }
            ...
            <div className="bg-gradient-to-r from-purple-900/50 to-cyan-900/50 p-8">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center gap-6">
                        <div className="w-20 h-20 rounded-full bg-gradient-to-r from-purple-500 to-cyan-500 flex items-center justify-center text-2xl font-bold">
                        ...
                        <div className="space-y-4">
                            {user.competitions.map((competition) => (
                                <Link
                                    ...
                                    className="block"
                                >
                                    <div className="p-4 bg-gray-900/50 rounded-lg border border-gray-700 hover:border-purple-500/50 transition-all duration-300">
