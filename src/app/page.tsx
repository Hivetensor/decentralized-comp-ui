                ...
                <div className="relative px-6 py-32 mx-auto max-w-7xl"> {/* More vertical padding */}
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        ...
                        <div className="flex-1 text-left">
                            ...
                            <div className="flex gap-4 mb-12">
                                <Link href="/competitions">
                                    <Button
                                        className="px-10 py-8 text-lg bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700">
                                        Join a Competition
                                    </Button>
                                </Link>
                        ...
                        <div className="flex-1 p-8">
                            <div
                                className="aspect-square bg-gray-800/50 rounded-lg flex items-center justify-center text-gray-400">
